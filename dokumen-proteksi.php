...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 main-content">
    <div class="row judul">
        <div class="col-12">
            <h2>Dokumen Administrasi Dokumen UPT Proteksi</h2>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    function fetchSurat(tahun, bulan, keyword, pegawaiID, suratType, targetID) {
        let url = `dokumen-administrasi/surat-${suratType}-proteksi.php?tahun=${tahun}&bulan=${bulan}&keyword=${keyword}&pegawai_id=${pegawaiID}`;
