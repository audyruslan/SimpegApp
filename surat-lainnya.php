                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between" id="headingOne">
                        <p class="mb-0 text-light">
                            <a href="tambah-surat-lainnya.php" class="text-light link-tambah">
                                <span class="badge badge-pill badge-light p-2">Tambah Surat Lainnya</span>
                            </a>
                        </p>
                        ...
                        <div class="card-body">
                            <div id="berkasPegawai" class="row">
                                ...
                                $sqlSurat = mysqli_query($conn, "SELECT * FROM tb_surat
                                                                ...
                                                                WHERE tb_surat.pegawai_id = $pegawaiID AND tb_surat.tipe_surat = 'Surat Lainnya' AND tb_surat.bidang = '$bidang'");
                                    ...
                                    <div class="card text-center">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex tombol">
                                                <a href="detail-surat-lainnya.php?surat_id=<?= $surat["surat_id"]; ?>"
...
document.addEventListener('DOMContentLoaded', function() {
    function fetchSurat(tahun, bulan, keyword) {
        ...
        xhr.open('GET',
            `surat-lainnya/cari.php?tahun=${tahun}&bulan=${bulan}&keyword=${keyword}&pegawai_id=${pegawaiID}`,
            true);
        xhr.onload = function() {
            if (this.status === 200) {
