                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between" id="headingOne">
                        <p class="mb-0 text-light">
                            <a href="tambah-surat-lainnya.php" class="text-light link-tambah">Tambah Surat Lainnya</a>
                        </p>
                        <div id="berkasSurat" class="pencarian-berkas d-flex" data-pegawai-id="<?= $pegawai["pegawai_id"]; ?>">
                            ...
                            <select class="form-control select-cari mr-2" id="cariBulanSurat" name="bulan_surat">
                                ...
                                <input type="text" class="form-control col-4 form-cari mr-5" id="cariSurat" placeholder="Cari Surat Lainnya...">
                        ...
                        <div id="berkasPegawai" class="row">
                            <?php 
                                ...
                                $sqlSurat = mysqli_query($conn, "SELECT * FROM tb_surat
                                                                ...
                                                                WHERE tb_surat.pegawai_id = $pegawaiID AND tb_surat.tipe_surat = 'Surat Lainnya'");
                            ...
                            <div class="col-2">
                                <div class="card text-center">
                                    ...
                                    <div class="d-flex tombol">
                                        <a href="detail-surat-lainnya.php?surat_id=<?= $surat["surat_id"]; ?>" class="badge badge-pill badge-primary mr-1">Lihat</a>
                            ...
                            <div class="col-12 text-center mt-5 mr-5 mb-5">
                                <h5>Maaf Surat Lainnya Belum Tersedia!</h5>
                            </div>
                            <?php 
                                } 
                            ?>
...
document.addEventListener('DOMContentLoaded', function() {
    function fetchSurat(tahun, bulan, keyword) {
        ...
        xhr.open('GET', `surat-lainnya/cari.php?tahun=${tahun}&bulan=${bulan}&keyword=${keyword}&pegawai_id=${pegawaiID}`, true);
        xhr.onload = function() {
            if (this.status === 200) {
