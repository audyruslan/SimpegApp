                ...
                <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body form-input">
                            <form id="berkasForm" action="surat-masuk/tambah.php" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="bidang" id="bidang" required>
                                                ...
                                                <option value="Bidang Sekretariat"
                                                    <?= ($pegawai["bidang"] == "Bidang Sekretariat") ? "selected" : ""; ?>>
                                                    Bidang Sekretariat</option>
                                                <option value="Bidang PSP"
                                                    <?= ($pegawai["bidang"] == "Bidang PSP") ? "selected" : ""; ?>>
                                                    Bidang PSP</option>
                                                <option value="Bidang Tanaman Pangan"
                                                    <?= ($pegawai["bidang"] == "Bidang Tanaman Pangan") ? "selected" : ""; ?>>
                                                    Bidang Tanaman Pangan</option>
                                                <option value="Bidang Hortikultura"
                                                    <?= ($pegawai["bidang"] == "Bidang Hortikultura") ? "selected" : ""; ?>>
                                                    Bidang Hortikultura</option>
                                                <option value="Bidang Penyuluhan"
                                                    <?= ($pegawai["bidang"] == "Bidang Penyuluhan") ? "selected" : ""; ?>>
                                                    Bidang Penyuluhan</option>
                                                <option value="UPT Proteksi"
                                                    <?= ($pegawai["bidang"] == "UPT Proteksi") ? "selected" : ""; ?>>UPT
                                                    Proteksi</option>
                                                <option value="UPT PMSB"
                                                    <?= ($pegawai["bidang"] == "UPT PMSB") ? "selected" : ""; ?>>UPT
                                                    PMSB</option>
                                                <option value="UPT Perbenihan"
                                                    <?= ($pegawai["bidang"] == "UPT Perbenihan") ? "selected" : ""; ?>>
                                                    UPT Perbenihan</option>
                                                <option value="UPT Diklat"
                                                    <?= ($pegawai["bidang"] == "UPT Diklat") ? "selected" : ""; ?>>UPT
                                                    Diklat</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="perihal_surat"
                                                name="perihal_surat" placeholder="Perihal Surat" autocomplete="off"
                                                required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="tgl_surat_masuk"
                                                name="tgl_surat_masuk" placeholder="Tanggal Surat Masuk" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="no_surat">Nomor Surat</label>
                                            <input type="text" class="form-control" id="no_surat" name="no_surat"
                                                placeholder="No. Surat" autocomplete="off" required>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="drop-zone">
                                            ...
                                            <img id="previewImage" class="drop-zone__image"
                                                style="display: none; width: 100%; height: auto;">
                                            <embed id="previewFile" class="drop-zone__pdf" type="application/pdf"
                                                style="display: none; width: 100%; height: 100%;">
                                        </div>
                                        <div class="d-flex justify-content-between mt-2">
                                            <input type="file" id="fileInput" name="surat"
