                            ...
                            <div id="dataSuratMasuk" class="row dataSurat">
                                <?php 
                                    ...
                                    $sqlSurat = mysqli_query($conn, "SELECT * FROM tb_surat
                                                                    ...
                                                                    WHERE tb_surat.tipe_surat = 'Surat Masuk' AND tb_surat.bidang = 'Bidang Sekretariat'");
...
document.addEventListener('DOMContentLoaded', function() {
    function fetchSurat(tahun, bulan, keyword, pegawaiID, suratType, targetID) {
        let url =
            `dokumen-administrasi/surat-${suratType}-sekretariat.php?tahun=${tahun}&bulan=${bulan}&keyword=${keyword}&pegawai_id=${pegawaiID}`;
