...
if (isset($_POST["daftar"])) {
  ...
  $role = 1;
  $img_dir = avatarAdmin(strtoupper($_POST["nama_lengkap"][0]));
  ...
  if (mysqli_num_rows($result) > 0) {
      ...
      if ($password !== $konfirmasi_password) {
          ...
          $insert_query = "INSERT INTO tb_admin (role_id, nama_lengkap, username, password, img_dir) VALUES ('$role', '$nama_lengkap', '$username', '$hashed_password', '$img_dir')";
          
          if (mysqli_query($conn, $insert_query)) {
              $_SESSION['success'] = "<strong>Registrasi berhasil, Silahkan Login!</strong>";
              $_SESSION['login_nip'] = $username;
          ...
          <div class="col-md-12">
            <div class="card-body register-form">
              ...
              <form id="quickForm" method="POST">
                ...
                <input type="text" class="form-control" id="username" name="username" value="<?php echo isset($_SESSION['username']) ? $_SESSION['username'] : ''; ?>" placeholder="Username" autocomplete="off">
