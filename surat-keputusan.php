                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between" id="headingOne">
                        <p class="mb-0 text-light">
                            <a href="tambah-surat-keputusan.php" class="text-light link-tambah">
                                <span class="badge badge-pill badge-light p-2">Tambah Surat Keputusan</span>
                            </a>
                        </p>
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            $sqlSurat = mysqli_query($conn, "SELECT * FROM tb_surat
                                                                ...
                                                                WHERE tb_surat.pegawai_id = $pegawaiID AND tb_surat.tipe_surat = 'Surat Keputusan' AND tb_surat.bidang = '$bidang'");
                                    ...
                                    <div class="card text-center">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex tombol">
                                                <a href="detail-surat-keputusan.php?surat_id=<?= $surat["surat_id"]; ?>"
...
document.addEventListener('DOMContentLoaded', function() {
    function fetchSurat(tahun, bulan, keyword) {
        ...
        xhr.open('GET',
            `surat-keputusan/cari.php?tahun=${tahun}&bulan=${bulan}&keyword=${keyword}&pegawai_id=${pegawaiID}`,
            true);
        xhr.onload = function() {
            if (this.status === 200) {
