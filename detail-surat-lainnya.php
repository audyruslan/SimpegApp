<?php 
    $title = "Detail Surat Lainnya";
    $menu = "Detail Surat Lainnya";
                    ...
                    <div class="card">
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body form-input">
                            <form id="berkasForm" action="surat-lainnya/ubah.php" method="POST" enctype="multipart/form-data">
