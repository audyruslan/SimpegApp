                    ...
                    <div class="card">
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body form-input">
                            <form id="berkasForm" action="surat-tugas/ubah.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="surat_id" value="<?= $surat["surat_id"]; ?>">
                                <input type="hidden" name="pegawai_id" value="<?= $surat["pegawai_id"]; ?>">
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="drop-zone">
                                            <embed id="previewSuratFile" class="drop-zone__pdf" src="surat-tugas/document/<?= $surat["surat_dir"]; ?>" type="application/pdf" style="display: <?= strpos($surat["surat_dir"], '.pdf') !== false ? 'block' : 'none'; ?>; width: 100%; height: 100%;">
                                        </div>
                                        <div class="d-flex justify-content-between mt-2">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-primary mr-2" name="ubah">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
