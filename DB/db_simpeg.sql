...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2024 at 12:59 PM
...
INSERT INTO `tb_pegawai` (`pegawai_id`, `role_id`, `jabatan_id`, `nama_lengkap`, `nip_pegawai`, `password_pegawai`, `tmp_lahir_pegawai`, `tgl_lahir_pegawai`, `agama_pegawai`, `status_perkawinan`, `no_hp_pegawai`, `pangkat_pegawai`, `pendidikan_terakhir`, `npwp_pegawai`, `ktp_pegawai`, `kapreg_pegawai`, `email_pegawai`, `unit_organisasi`, `unit_kerja`, `nama_suami_istri`, `pekerjaan`, `nip_suami_istri`, `alamat_pegawai`, `img_dir`) VALUES
...
(2, 2, 6, 'Fikran', '198106022015022001', '$2y$10$u79gDNOjJNaQQrXSuuk5Ou2lj8Hiv/KV60mH18EW4emS5wXGcBClq', '', '0000-00-00', '', '', '', '', '', '', '', '', 'fikran@gmail.com', '', '', '', '', '', '', '1722754362.png');
...
--
ALTER TABLE `tb_validasi_berkas`
  MODIFY `validasi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
