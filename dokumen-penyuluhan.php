<?php 
    $title = "Dokumen Penyuluhan";
    $menu = "Dokumen Penyuluhan";
    $bidang_menu = "UPT Penyuluhan";
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 main-content">
    <div class="row judul">
        <div class="col-12">
            <h2>Dokumen Administrasi UPT Penyuluhan</h2>
        </div>
    </div>
                            ...
                            <div id="dataSuratMasuk" class="row dataSurat">
                                <?php 
                                    ...
                                    $sqlSurat = mysqli_query($conn, "SELECT * FROM tb_surat
                                                                    ...
                                                                    WHERE tb_surat.pegawai_id = $pegawaiID AND tb_surat.tipe_surat = 'Surat Masuk' AND tb_surat.bidang = 'Bidang Penyuluhan'");
                            ...
                            <div id="dataSuratKeluar" class="row dataSurat">
                                <?php 
                                    ...
                                    $sqlSurat = mysqli_query($conn, "SELECT * FROM tb_surat
                                                                    INNER JOIN tb_pegawai
                                                                    ON tb_surat.pegawai_id = tb_pegawai.pegawai_id 
                                                                    WHERE tb_surat.pegawai_id = $pegawaiID AND tb_surat.tipe_surat = 'Surat Keluar' AND tb_surat.bidang = 'Bidang Penyuluhan'");
                                    if (mysqli_num_rows($sqlSurat) > 0) {
                                        while($surat = mysqli_fetch_assoc($sqlSurat)) {
                                ?>
                                <div class="col-2">
                            ...
                            <div id="dataSuratKeputusan" class="row dataSurat">
                                <?php 
                                    ...
                                    $sqlSurat = mysqli_query($conn, "SELECT * FROM tb_surat
                                                                    INNER JOIN tb_pegawai
                                                                    ON tb_surat.pegawai_id = tb_pegawai.pegawai_id 
                                                                    WHERE tb_surat.pegawai_id = $pegawaiID AND tb_surat.tipe_surat = 'Surat Keputusan' AND tb_surat.bidang = 'Bidang Penyuluhan'");
                                    if (mysqli_num_rows($sqlSurat) > 0) {
                                        while($surat = mysqli_fetch_assoc($sqlSurat)) {
                                ?>
                                <div class="col-2">
                            ...
                            <div id="dataSuratTugas" class="row dataSurat">
                                <?php 
                                    ...
                                    $sqlSurat = mysqli_query($conn, "SELECT * FROM tb_surat
                                                                    INNER JOIN tb_pegawai
                                                                    ON tb_surat.pegawai_id = tb_pegawai.pegawai_id 
                                                                    WHERE tb_surat.pegawai_id = $pegawaiID AND tb_surat.tipe_surat = 'Surat Tugas' AND tb_surat.bidang = 'Bidang Penyuluhan'");
                                    if (mysqli_num_rows($sqlSurat) > 0) {
                                        while($surat = mysqli_fetch_assoc($sqlSurat)) {
                                ?>
                                <div class="col-2">
                            ...
                            <div id="dataSuratLainnya" class="row dataSurat">
                                <?php 
                                    ...
                                    $sqlSurat = mysqli_query($conn, "SELECT * FROM tb_surat
                                                                    INNER JOIN tb_pegawai
                                                                    ON tb_surat.pegawai_id = tb_pegawai.pegawai_id 
                                                                    WHERE tb_surat.pegawai_id = $pegawaiID AND tb_surat.tipe_surat = 'Surat Lainnya' AND tb_surat.bidang = 'Bidang Penyuluhan'");
                                    if (mysqli_num_rows($sqlSurat) > 0) {
                                        while($surat = mysqli_fetch_assoc($sqlSurat)) {
                                ?>
                                <div class="col-2">
...
document.addEventListener('DOMContentLoaded', function() {
    function fetchSurat(tahun, bulan, keyword, pegawaiID, suratType, targetID) {
        let url =
            `dokumen-administrasi/surat-${suratType}-penyuluhan.php?tahun=${tahun}&bulan=${bulan}&keyword=${keyword}&pegawai_id=${pegawaiID}`;
