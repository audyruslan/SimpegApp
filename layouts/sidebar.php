        ...
        <div class="sidebar-sticky">
          ...
          <ul class="nav flex-column">
            <li class="nav-item mt-5">
              <a class="nav-link <?php if ($menu == "Dashboard" || $menu == "Detail Pegawai") echo "active"; ?>" href="home.php">
                Halaman Utama
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if ($menu == "Berkas Pegawai" || $menu == "Detail Berkas Pegawai" || $menu == "Lihat Berkas Pegawai") echo "active"; ?>" href="berkas-pegawai.php">
                Berkas Pegawai
              </a>
            </li>
            ...
            <div class="modal fade" id="logoutModalAdmin" tabindex="-1" role="dialog" aria-labelledby="exampleModaAdmin"
                aria-hidden="true">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item <?php if ($menu == "Surat Masuk" || $menu == "Detail Surat Masuk" || $menu == "Tambah Surat Masuk"  || $menu == "Surat Keluar" || $menu == "Detail Surat Keluar" || $menu == "Tambah Surat Keluar" || $menu == "Surat Keputusan" || $menu == "Detail Surat Keputusan" || $menu == "Tambah Surat Keputusan" || $menu == "Surat Tugas" || $menu == "Detail Surat Tugas" || $menu == "Tambah Surat Tugas" || $menu == "Surat Lainnya" || $menu == "Detail Surat Lainnya" || $menu == "Tambah Surat Lainnya") echo "active-menu"; ?>">
              ...
              <div class="collapse <?php if ($menu == "Surat Masuk" || $menu == "Detail Surat Masuk" || $menu == "Tambah Surat Masuk" || $menu == "Surat Keluar" || $menu == "Detail Surat Keluar" || $menu == "Tambah Surat Keluar" || $menu == "Surat Keputusan" || $menu == "Detail Surat Keputusan" || $menu == "Tambah Surat Keputusan" || $menu == "Surat Tugas" || $menu == "Detail Surat Tugas" || $menu == "Tambah Surat Tugas" || $menu == "Surat Lainnya" || $menu == "Detail Surat Lainnya" || $menu == "Tambah Surat Lainnya") echo "show"; ?>" id="submenu">
                <ul class="nav flex-column ml-3">
                  <li class="nav-item">
                    <a class="nav-link submenu-link <?php if ($menu == "Surat Masuk" || $menu == "Detail Surat Masuk" || $menu == "Tambah Surat Masuk") echo "active"; ?>" href="surat-masuk.php">Surat Masuk</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link submenu-link <?php if ($menu == "Surat Keluar" || $menu == "Detail Surat Keluar" || $menu == "Tambah Surat Keluar") echo "active"; ?>" href="surat-keluar.php">Surat Keluar</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link submenu-link <?php if ($menu == "Surat Keputusan" || $menu == "Detail Surat Keputusan" || $menu == "Tambah Surat Keputusan") echo "active"; ?>" href="surat-keputusan.php">Surat Keputusan</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link submenu-link <?php if ($menu == "Surat Tugas" || $menu == "Detail Surat Tugas" || $menu == "Tambah Surat Tugas") echo "active"; ?>" href="surat-tugas.php">Surat Tugas</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link submenu-link <?php if ($menu == "Surat Lainnya" || $menu == "Detail Surat Lainnya" || $menu == "Tambah Surat Lainnya") echo "active"; ?>" href="surat-lainnya.php">Surat Lainnya</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="logout.php" data-toggle="modal" data-target="#logoutModalBidangPegawai">
                Logout
              </a>
            </li>

            <!-- Logout Modal-->
            <div class="modal fade" id="logoutModalBidangPegawai" tabindex="-1" role="dialog" aria-labelledby="ModalBidangPegawai"
                aria-hidden="true">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              ...
              <!-- Logout Modal-->
              <div class="modal fade" id="logoutModalPegawai" tabindex="-1" role="dialog" aria-labelledby="ModalPegawai"
                aria-hidden="true">
                  <div class="modal-dialog" role="document">
                      <div class="modal-content">
                          <div class="modal-header">
