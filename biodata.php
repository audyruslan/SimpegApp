                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="agama_pegawai" id="agama_pegawai">
                                        ...
                                        <option value="Islam"
                                            <?= ($pegawai["agama_pegawai"] == "Islam") ? "selected" : ""; ?>>Islam
                                        </option>
                                        <option value="Kristen"
                                            <?= ($pegawai["agama_pegawai"] == "Kristen") ? "selected" : ""; ?>>Kristen
                                        </option>
                                        <option value="Katolik"
                                            <?= ($pegawai["agama_pegawai"] == "Katolik") ? "selected" : ""; ?>>Katolik
                                        </option>
                                        <option value="Hindu"
                                            <?= ($pegawai["agama_pegawai"] == "Hindu") ? "selected" : ""; ?>>Hindu
                                        </option>
                                        <option value="Buddha"
                                            <?= ($pegawai["agama_pegawai"] == "Buddha") ? "selected" : ""; ?>>Buddha
                                        </option>
                                        <option value="Konghucu"
                                            <?= ($pegawai["agama_pegawai"] == "Konghucu") ? "selected" : ""; ?>>Konghucu
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status_perkawinan" id="status_perkawinan">
                                        ...
                                        <option value="Cerai Hidup"
                                            <?= ($pegawai["status_perkawinan"] == "Cerai Hidup") ? "selected" : ""; ?>>
                                            Cerai Hidup</option>
                                        <option value="Cerai Mati"
                                            <?= ($pegawai["status_perkawinan"] == "Cerai Mati") ? "selected" : ""; ?>>
                                            Cerai Mati</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="pangkat_pegawai" id="pangkat_pegawai">
                                        ...
                                        <option value="IA - Juru Muda"
                                            <?= ($pegawai["pangkat_pegawai"] == "IA - Juru Muda") ? "selected" : ""; ?>>
                                            IA - Juru Muda</option>
                                        <option value="IB - Juru Muda Tingkat I"
                                            <?= ($pegawai["pangkat_pegawai"] == "IB - Juru Muda Tingkat I") ? "selected" : ""; ?>>
                                            IB - Juru Muda Tingkat I</option>
                                        <option value="IC - Juru"
                                            <?= ($pegawai["pangkat_pegawai"] == "IC - Juru") ? "selected" : ""; ?>>IC -
                                            Juru</option>
                                        <option value="ID - Juru Tingkat I"
                                            <?= ($pegawai["pangkat_pegawai"] == "ID - Juru Tingkat I") ? "selected" : ""; ?>>
                                            ID - Juru Tingkat I</option>
                                        <option value="IIA - Pengatur Muda"
                                            <?= ($pegawai["pangkat_pegawai"] == "IIA - Pengatur Muda") ? "selected" : ""; ?>>
                                            IIA - Pengatur Muda</option>
                                        <option value="IIB - Pengatur Muda Tingkat I"
                                            <?= ($pegawai["pangkat_pegawai"] == "IIB - Pengatur Muda Tingkat I") ? "selected" : ""; ?>>
                                            IIB - Pengatur Muda Tingkat I</option>
                                        <option value="IIC - Pengatur"
                                            <?= ($pegawai["pangkat_pegawai"] == "IIC - Pengatur") ? "selected" : ""; ?>>
                                            IIC - Pengatur</option>
                                        <option value="IID - Pengatur Tingkat I"
                                            <?= ($pegawai["pangkat_pegawai"] == "IID - Pengatur Tingkat I") ? "selected" : ""; ?>>
                                            IID - Pengatur Tingkat I</option>
                                        <option value="IIIA - Penata Muda"
                                            <?= ($pegawai["pangkat_pegawai"] == "IIIA - Penata Muda") ? "selected" : ""; ?>>
                                            IIIA - Penata Muda</option>
                                        <option value="IIIB - Penata Muda Tingkat I"
                                            <?= ($pegawai["pangkat_pegawai"] == "IIIB - Penata Muda Tingkat I") ? "selected" : ""; ?>>
                                            IIIB - Penata Muda Tingkat I</option>
                                        <option value="IIIC - Penata"
                                            <?= ($pegawai["pangkat_pegawai"] == "IIIC - Penata") ? "selected" : ""; ?>>
                                            IIIC - Penata</option>
                                        <option value="IIID - Penata Tingkat I"
                                            <?= ($pegawai["pangkat_pegawai"] == "IIID - Penata Tingkat I") ? "selected" : ""; ?>>
                                            IIID - Penata Tingkat I</option>
                                        <option value="IVA - Pembina"
                                            <?= ($pegawai["pangkat_pegawai"] == "IVA - Pembina") ? "selected" : ""; ?>>
                                            IVA - Pembina</option>
                                        <option value="IVB - Pembina Tingkat I"
                                            <?= ($pegawai["pangkat_pegawai"] == "IVB - Pembina Tingkat I") ? "selected" : ""; ?>>
                                            IVB - Pembina Tingkat I</option>
                                        <option value="IVC - Pembina Utama Muda"
                                            <?= ($pegawai["pangkat_pegawai"] == "IVC - Pembina Utama Muda") ? "selected" : ""; ?>>
                                            IVC - Pembina Utama Muda</option>
                                        <option value="IVD - Pembina Utama Madya"
                                            <?= ($pegawai["pangkat_pegawai"] == "IVD - Pembina Utama Madya") ? "selected" : ""; ?>>
                                            IVD - Pembina Utama Madya</option>
                                        <option value="IVE - Pembina Utama"
                                            <?= ($pegawai["pangkat_pegawai"] == "IVE - Pembina Utama") ? "selected" : ""; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="pendidikan_terakhir" id="pendidikan_terakhir">
                                        ...
                                        <option value="Sekolah Dasar (SD)"
                                            <?= ($pegawai["pendidikan_terakhir"] == "Sekolah Dasar (SD)") ? "selected" : ""; ?>>
                                            Sekolah Dasar (SD)</option>
                                        <option value="Sekolah Menengah Pertama (SMP)"
                                            <?= ($pegawai["pendidikan_terakhir"] == "Sekolah Menengah Pertama (SMP)") ? "selected" : ""; ?>>
                                            Sekolah Menengah Pertama (SMP)</option>
                                        <option value="Sekolah Menengah Atas (SMA)"
                                            <?= ($pegawai["pendidikan_terakhir"] == "Sekolah Menengah Atas (SMA)") ? "selected" : ""; ?>>
                                            Sekolah Menengah Atas (SMA)</option>
                                        <option value="Diploma I (D1)"
                                            <?= ($pegawai["pendidikan_terakhir"] == "Diploma I (D1)") ? "selected" : ""; ?>>
                                            Diploma I (D1)</option>
                                        <option value="Diploma II (D2)"
                                            <?= ($pegawai["pendidikan_terakhir"] == "Diploma II (D2)") ? "selected" : ""; ?>>
                                            Diploma II (D2)</option>
                                        <option value="Diploma III (D3)"
                                            <?= ($pegawai["pendidikan_terakhir"] == "Diploma III (D3)") ? "selected" : ""; ?>>
                                            Diploma III (D3)</option>
                                        <option value="Diploma IV (D4)"
                                            <?= ($pegawai["pendidikan_terakhir"] == "Diploma IV (D4)") ? "selected" : ""; ?>>
                                            Diploma IV (D4)</option>
                                        <option value="Sarjana (S1)"
                                            <?= ($pegawai["pendidikan_terakhir"] == "Sarjana (S1)") ? "selected" : ""; ?>>
                                            Sarjana (S1)</option>
                                        <option value="Magister (S2)"
                                            <?= ($pegawai["pendidikan_terakhir"] == "Magister (S2)") ? "selected" : ""; ?>>
                                            Magister (S2)</option>
                                        <option value="Doktor (S3)"
                                            <?= ($pegawai["pendidikan_terakhir"] == "Doktor (S3)") ? "selected" : ""; ?>>
                                            Doktor (S3)</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="jabatan_id" id="jabatan_id">
                                        ...
                                        <option value="<?= $jabatan["jabatan_id"]; ?>"
                                            <?= ($pegawai["jabatan_id"] == $jabatan["jabatan_id"]) ? "selected" : ""; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="unit_organisasi" name="unit_organisasi"
                                        value="<?= $pegawai["unit_organisasi"]; ?>" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label for="unit_kerja">Unit Kerja</label>
                                    <input type="text" class="form-control" id="unit_kerja" name="unit_kerja"
                                        value="<?= $pegawai["unit_kerja"]; ?>" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label for="nama_suami_istri">Nama Suami/Istri</label>
                                    <input type="text" class="form-control" id="nama_suami_istri"
                                        name="nama_suami_istri" value="<?= $pegawai["nama_suami_istri"]; ?>"
                                        autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label for="pekerjaan">Pekerjaan</label>
                                    <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"
                                        value="<?= $pegawai["pekerjaan"]; ?>" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nip_suami_istri" name="nip_suami_istri"
                                        value="<?= $pegawai["nip_suami_istri"]; ?>" autocomplete="off">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="role_id" id="role_id" disabled>
                                ...
                                <option value="<?= $role["role_id"]; ?>"
                                    <?= ($pegawai["role_id"] == $role["role_id"]) ? "selected" : ""; ?>>
                                    <?= $role["role"]; ?></option>
                                <?php 
                                    }
                                ?>
